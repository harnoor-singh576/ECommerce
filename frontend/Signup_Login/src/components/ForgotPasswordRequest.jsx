...
const ForgotPasswordRequest = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                showMessage(data.message || 'If a user with that email exists, a password reset link has been sent to your inbox.', 'success');
                ...
                showMessage(data.message || 'Failed to send password reset email. Please try again.', 'error');
            }
        } catch (error) {
