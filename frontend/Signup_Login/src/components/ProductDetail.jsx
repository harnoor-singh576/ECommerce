        ...
        const fetchProduct = async () => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    showMessage(data.message || 'Failed to fetch product details.', 'error');
        ...
        <div className="container product-detail-container">
            ...
            <div className="product-detail-content">
                ...
                <div className="product-info">
                    ...
                    <p><strong>Added by:</strong> {product.user?.username || product.user?.email || 'Unknown'}</p>
                    ...
                    {user && product.user && user._id === product.user._id && (
                        <Link to={`/edit-product/${product._id}`} className="edit-button">Edit Product</Link>
                    )}
